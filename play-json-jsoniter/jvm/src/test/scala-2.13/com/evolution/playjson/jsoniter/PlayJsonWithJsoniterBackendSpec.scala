...
import com.evolution.playjson.jsoniter.TestDataGenerators.{User, genUser}
import org.scalacheck.Prop.forAll
import org.scalacheck.{Arbitrary, Gen, Test}
import play.api.libs.json.{JsSuccess, Json}

//sbt playJsonJsoniter/test:"runMain com.evolution.playjson.jsoniter.PlayJsonWithJsoniterBackendSpec"
